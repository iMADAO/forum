...
<form action="<%=request.getContextPath() %>/appendMessage" method="post" enctype="multipart/form-data">
<input type="hidden" value="<%=request.getParameter("postId")%>" name="postId"/>
	<table>
		<tr>
			<td>内容</td>
